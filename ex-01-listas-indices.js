...
const frutas = ["maçã", "banana", "laranja", "uva", "pêra", "manga"]
 export const reposta01 = frutas[1]
...
*/
// Operações necessárias e resposta a partir da linha abaixo
export const resposta03 = frutas[4]
...
const frutas = ["maçã", "banana", "laranja","uva","pera","manga", "limão" ]
...
Crie um array (também com const ao invés de let) chamado "numeros" com os valores
 6,7, 2, 4, 9, 8, 1 nesta ordem. Armazene na variável "resposta06" o resultado do
número no índice zero multiplicado pelo item no penúltimo índice.
*/
// Array na linha abaixo

// Operações necessárias e resposta a partir da linha abaixo
export const resposta06 = 48
const numeros = [6,7, 2, 4, 9, 8, 1 ]
