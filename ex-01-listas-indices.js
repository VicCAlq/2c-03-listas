...
// Operações necessárias e resposta a partir da linha abaixo
frutas[3] = "abacaxi"
export const resposta03 = Array.from(frutas)
...
// Operações necessárias e resposta a partir da linha abaixo
frutas = [...frutas, "limão"]
export const resposta04 = Array.from(frutas)
...
export const resposta05 = Array.from(frutas)
...
for (let i = numeros.length - 1; i >= 0; i--)
    numeros[i] = i > 0 ? numeros[i - 1] : ultimoNumero
