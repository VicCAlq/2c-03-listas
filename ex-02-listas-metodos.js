...
profissoes.push("programado(a)","designer","engenheiro(a)","veterinário(a)","administrador(a)");
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const primeiroAtualItemRemovido = profissoes.shift();
export const resposta04 = primeiroAtualItemRemovido;
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const listaDeRemovidos = [];
listaDeRemovidos.push(itemRemovido, primeiroAtualItemRemovido);
profissoes = profissoes.concat(listaDeRemovidos);
