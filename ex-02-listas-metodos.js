...
*/
profissoes.push("programador(a)", "designer","engenheiro(a)", "veterinário(a)")
const profissoes2 = ["administrador(a)", "músico(a)"]
profissoes.concat(profissoes2)
...
const invertebrados = []
invertebrados.push("polvo", "formiga" e "caranguejo")
const animais = []
...
*/
const são = animais.pop
const só = animais.pop
const coisasQuebradas = animais.pop
...
*/
peixeAveMamifero = ["carcará", "morcego" e "salmão"]
animais.concat(peixeAveMamifero)
animais.reverse
rastejantesInsetoseGosmentos = ["lesma", "borboleta" e "ostra"]
animais.concat(rastejantesInsetoseGosmentos)
// Operações necessárias e resposta a partir da linha abaixo
