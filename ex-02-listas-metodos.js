...
let profissoes = ["programador(a)", "designer",
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const ultimoRemove = [profissoes.pop()]
export const resposta02 = ultimoRemove
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const uS = [profissoes.shift()]
export const resposta04 = uS
...
// Operações necessárias e resposta a partir da linha abaixo
let novaLista = []
novaLista = novaLista.concat(profissoes,ultimoRemove,uS)
