...
const removidaPop = profissoes.pop()

export const resposta02 = removidaPop
...
export const resposta03 = profissoesprofissoes.unshift("músico(a)")
...
const removidaShift = profissoes.shift()

export const resposta04 = removidaShift
...
const removidas = [removidaPop, removidaShift]

const listaConcat = profissoes.concat(removidas)
...
listaAnimais.unshift(listaAnimais.pop())
listaAnimais.unshift(listaAnimais.pop())
listaAnimais.unshift(listaAnimais.pop())
...
let listaAnimais2 = listaAnimais.concat(["carcará","morcego","salmão"])

listaAnimais2.reverse()

listaAnimais2 = listaAnimais2.concat(["lesma","borboleta","ostra"])

export const resposta10 = listaAnimais2
...
listaPedras.push(listaPedras.shift())
listaPedras.push(listaPedras.shift())
listaPedras.push(listaPedras.shift())
...
removidos.push(listaPedras.pop())
removidos.push(listaPedras.pop())
removidos.push(listaPedras.pop())
removidos.push(listaPedras.pop())
removidos.push(listaPedras.pop())
