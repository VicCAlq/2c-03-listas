...
const profissoesQ5 = profissoes.concat(removidas)
export const resposta05 = profissoesQ5
...
const animaisQ7 = animais.concat(vertebrados, invertebrados)
export const resposta07 = animaisQ7
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const animaisQ8 = animaisQ7.concat()

animaisQ8.unshift(animaisQ8.pop())
animaisQ8.unshift(animaisQ8.pop())
animaisQ8.unshift(animaisQ8.pop())

export const resposta08 = animaisQ8
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const animaisQ9 = animaisQ8.concat()

animaisQ9.reverse()

animaisQ9.push(animaisQ9.shift())
animaisQ9.push(animaisQ9.shift())
animaisQ9.push(animaisQ9.shift())
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const animaisQ10 = animaisQ9.concat("carcará", "morcego", "salmão")

animaisQ10.reverse()

const animaisFinalQ10 = animaisQ10.concat("lesma", "borboleta", "ostra")
...
const pedrasQ11 = pedras.concat("quartzo", "basalto", "granito")

pedrasQ11.reverse()

pedrasQ11.push("calcário", "mármore", "mica")

pedrasQ11.reverse()

export const resposta11 = pedrasQ11
