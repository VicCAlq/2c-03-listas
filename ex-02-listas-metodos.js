...
const lista05 = profissoes.concat(removidas)
...
// Operações necessárias e resposta a partir da linha abaixo
lista05.reverse()
export const resposta06 = lista05
...
*/
// Operações necessárias e resposta a partir da linha abaixo
animais.unshift(animais.pop()) // caranguejo
animais.unshift(animais.pop()) // formiga
animais.unshift(animais.pop()) // polvo
...
*/
// Operações necessárias e resposta a partir da linha abaixo
animais.push("carcará", "morcego", "salmão")
animais.reverse()
animais.push("lesma", "borboleta", "ostra")
...
const lista12 = pedras.concat(["topázio", "lazurita", "ônix"])
export const resposta12 = lista12
