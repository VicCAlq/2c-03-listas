...
*/
// Operações necessárias e resposta a partir da linha abaixo
const itemRemove = profissoes.shift()
export const resposta04 = itemRemove
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const profissoesDelete = [itemRemovido, itemRemove]
const listaRemovida = profissoes.concat(profissoesDelete)
export const resposta05 = listaRemovida
...
tempAnimalesco = listaAnimais.pop()
listaAnimais.unshift(tempAnimalesco)
tempAnimalesco = listaAnimais.pop()
listaAnimais.unshift(tempAnimalesco)
tempAnimalesco = listaAnimais.pop()
listaAnimais.unshift(tempAnimalesco)
