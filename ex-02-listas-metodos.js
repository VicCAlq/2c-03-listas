...
export const resposta01 = Array.from(profissoes)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const ultimaProfissao = profissoes.pop()
export const resposta02 = ultimaProfissao
...
export const resposta03 = Array.from(profissoes)
...
*/
// Operações necessárias e resposta a partir da linha abaixo
const primeiraProfissao = profissoes.shift()
...
*/
// Operações necessárias e resposta a partir da linha abaixo
profissoes = profissoes.concat([ultimaProfissao, primeiraProfissao])
export const resposta05 = Array.from(profissoes)
...
// Operações necessárias e resposta a partir da linha abaixo
profissoes.reverse()
export const resposta06 = Array.from(profissoes)
...
lista "animais" para juntar o conteúdo das listas "vertebrados" e "invertebrados" 
...
export const resposta07 = Array.from(animais)
...
export const resposta08 = Array.from(animais)
...
export const resposta09 = Array.from(animais)
...
export const resposta10 = Array.from(animais)
...
pedras.reverse()
export const resposta11 = Array.from(pedras)
...
export const resposta12 = Array.from(pedras)
...
pedras.reverse()
export const resposta13 = Array.from(pedras)
...
const novasPedras = []
for (let _ = 0; _ < 6; _++)
    novasPedras.push(pedras.pop())

export const resposta14 = Array.from(novasPedras)
